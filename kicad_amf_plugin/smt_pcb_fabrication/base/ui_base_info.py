...
class UiBaseInfo ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.application_sphere_label.SetToolTip( _(u"Non-conductive base material") )
		...
		self.application_sphere.SetToolTip( _(u"Non-conductive base material") )

		fgSizer2.Add( self.application_sphere, 0, wx.ALL|wx.EXPAND, 5 )

		self.is_pcb_soft_board_label = wx.StaticText( sbSizer2.GetStaticBox(), wx.ID_ANY, _(u"pcb soft board"), wx.DefaultPosition, wx.DefaultSize, 0 )
