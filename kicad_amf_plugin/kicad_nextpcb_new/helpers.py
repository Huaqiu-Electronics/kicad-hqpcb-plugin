...
def is_nightly(version: str) -> bool:
    ...
    return any(v in version for v in ("6.99", "7.0", "7.99", "8.0", "8.99"))
...
def get_pcb_value(fp):
    """Get the first number (C123456 for example) from the properties of the footprint."""
    try:
        ...
        # Handle the case where 'GetProperties' is not available for the FOOTPRINT object
        return ""
