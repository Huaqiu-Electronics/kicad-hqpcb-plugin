...
class UiSearchPanel ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.mpn_textctrl_label = wx.StaticText( self, wx.ID_ANY, u"MPN：", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.search_button = wx.Button( self, wx.ID_ANY, u"Search", wx.DefaultPosition, wx.Size( 100,28 ), 0 )
